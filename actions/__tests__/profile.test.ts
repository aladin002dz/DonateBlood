...
describe('getProfile', () => {
  ...
  it('should successfully get user profile', async () => {
    const mockSession = {
      user: { id: 'user-id', email: 'test@example.com', name: 'Test User', emailVerified: false, image: null, createdAt: new Date(), updatedAt: new Date(), banned: null, role: 'user', banReason: null, banExpires: null },
